...
var $author$project$Main$PrevWord = {$: 'PrevWord'};
var $author$project$Main$RawKey = function (a) {
	return {$: 'RawKey', a: a};
};
var $author$project$Main$ReadLine = {$: 'ReadLine'};
var $author$project$Main$processKeyb = F2(
	function (mode, rawKey) {
		if (mode.$ === 'Normal') {
			switch (rawKey) {
				case ' ':
					return $author$project$Main$ReadLine;
				case 'l':
					return $author$project$Main$NextWord;
				case 'h':
					return $author$project$Main$PrevWord;
				case ':':
					return $author$project$Main$EnterCommandMode;
				default:
					return $author$project$Main$DoNothing;
			}
		} else {
			if (rawKey === 'Escape') {
				return $author$project$Main$ExitTypingMode;
			} else {
				return $author$project$Main$RawKey(rawKey);
			}
		}
	});
var $author$project$Main$keyDecoder = function (mode) {
	return A2(
		...
		$author$project$Main$processKeyb(mode),
...
var $author$project$Main$footerLayout = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_ui$Element$rgb255, 61, 61, 61)),
				$mdgriffith$elm_ui$Element$spacing(10),
				$mdgriffith$elm_ui$Element$Border$rounded(8),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$style, 'box-shadow', '5px 5px 10px #323232, -5px -5px 10px #484848'))
			]),
		_List_fromArray(
			[
...
var $author$project$Main$menuLayout = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text('Menu TODO')
			]));
};
...
var $author$project$Main$bottomMarkerSymbol = '⥿';
...
var $author$project$Main$centeredElem = function (element) {
	return _List_fromArray(
		[
			A2(
...
var $author$project$Main$computeCenter = function (word) {
	var wordLen = $elm$core$String$length(word);
	return (wordLen <= 2) ? 0 : ((!A2($elm$core$Basics$modBy, wordLen, 2)) ? $elm$core$Basics$round((wordLen / 2) - 2) : $elm$core$Basics$round((wordLen / 2) - 2));
};
var $author$project$Main$divideWord = function (maybeWord) {
	return A2(
		$elm$core$Maybe$map,
		function (word) {
			var centerIdx = $author$project$Main$computeCenter(word);
			return {
				center: A3($elm$core$String$slice, centerIdx, centerIdx + 1, word),
				left: A3($elm$core$String$slice, 0, centerIdx, word),
				right: A3(
					$elm$core$String$slice,
					centerIdx + 1,
...
var $author$project$Main$topMarkerSymbol = '⥾';
var $author$project$Main$wordLayout = function (model) {
	var wordParts = A2(
		$elm$core$Maybe$withDefault,
		{center: '🕮', left: '', right: ''},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$centeredElem(
					A2(
						...
						$mdgriffith$elm_ui$Element$text($author$project$Main$topMarkerSymbol)))),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(wordParts.left)
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(wordParts.center)
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(wordParts.right)
									]))
							]))
					])),
				A2(
				...
				$author$project$Main$centeredElem(
					A2(
						...
						$mdgriffith$elm_ui$Element$text($author$project$Main$bottomMarkerSymbol))))
			]));
};
var $author$project$Main$mainLayout = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Element$spacingXY, 0, 3),
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 61, 61, 61)),
				...
				_List_fromArray(
					[
						...
						{name: 'Montserrat', url: 'https://fonts.googleapis.com/css?family=Montserrat'}),
		...
		_List_fromArray(
			[
				$author$project$Main$menuLayout(model),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$author$project$Main$wordLayout(model)
					])),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
				...
				_List_Nil),
				$author$project$Main$footerLayout(model)
			]));
};
var $author$project$Main$body = function (model) {
	return A2(
		...
		_List_Nil,
		$author$project$Main$mainLayout(model));
};
